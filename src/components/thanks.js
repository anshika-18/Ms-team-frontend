    ...
    return (
        <div className="thanks-outer">
            ...
            <div className={rated?"hidden":null}>
                <div className="feedback-head">How was the Audio and Video Quality?</div>
                <div className="feedback">
                
                    <ReactStars classNames="stars" className="stars"
                        count={5}
                        ...
                        activeColor="blue"
                    />
                    <Button className="feedback-button" onClick={()=>{feedback()}} variant="success">Submit</Button>
                </div>
            </div>
