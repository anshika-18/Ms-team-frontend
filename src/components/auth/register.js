             ...
             <div className="forms-container-div">
                 ...
                 <img className="login-profile" src={Profile} alt="profile-girl"></img>
                  ...
                  <h2 className="title">Verify OTP</h2>
                    <input type="test" value={otp} name="otp" onChange={(e)=>setOtp(e.target.value)} placeholder="Enter otp"></input>
                    <input className="submit-register" type="submit" value="Register" onClick={(e)=>{onSubmit(e)}} />
                    <input className="submit-register" type="submit" value="Resend OTP" onClick={(e)=>{resend(e)}} />
                    <h6>*Please check your mail for OTP. Also check your spam folder.</h6>
                    <button className="old-user" onClick={props.setLogin}>Already have an Account?</button>
                  </form>
                </div>
          </div>
